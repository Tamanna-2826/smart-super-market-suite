-- Create role enum
CREATE TYPE public.app_role AS ENUM ('admin', 'supervisor', 'cashier');
...
INSERT INTO public.products (name, barcode, category_id, description, unit_price, stock_quantity, reorder_level)
SELECT 
  'Sample Product ' || generate_series,
  'BAR' || LPAD(generate_series::TEXT, 10, '0'),
